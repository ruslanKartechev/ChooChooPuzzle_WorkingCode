...
{
    public class LeanEffectHadnler : EffectCommandHandler
    {
        ...
        public LeanEffectHadnler(List<ChainSegmentData> info, ChainEffect_Lean settings, ChainPositionInfo currentPositions)
        {
            segments = info;
            _settings = settings;
